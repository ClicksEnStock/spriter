...
public class Data {
    ...
    /**
     * Returns number of {@link Files} for provided {@link Folder}.
     * @param folderId indes of the folder
     * @return the number of files for given folder
     */
    public int getFileCount(int folderId){
        return this.folders[folderId].files.length;
    }
